...
module.exports = {
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      artist: 'JMSN',
      url: 'https://music.163.com/song?id=1330929303&uct2=U2FsdGVkX1+9QNxMXIYjSTgYPIBfz5tLbxeAuVcZdmk=',
      cover:
        'http://p2.music.126.net/IOWknoktxM0mPoaAq2BH0w==/109951167213880378.jpg'
    },
    {
      name: '王都グランセル',
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '13688562746', // 对应歌单的 id
